...
export type DriverMode = 'idle' | 'generating' | 'recovering' | 'degraded' | 'shutdown';
...
export type RecoveryAction = 'none' | 'refresh-page' | 'reopen-page' | 'restart-browser' | 'rebuild-session';
...
export type PageMode = 'ready' | 'unauthenticated' | 'challenge' | 'error' | 'loading';
